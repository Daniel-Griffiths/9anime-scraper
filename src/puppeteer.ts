 ...
 *
 * @param   {LaunchOptions} options Specify custom puppeteer options
 * @param   {boolean} isServerless Required if this runs on a serverless lambda
...
export const createPuppeteerInstance = async (
  ...
  const defaultOptions: LaunchOptions = {
    ...
    executablePath: isServerless ? await chrome.executablePath : findChrome(),
    args: isServerless
      ? chrome.args
      : [
          "--no-pings",
